...
$silos = [
    [
        'name' => 'Estimation & Avis de valeur à Bordeaux',
        'color' => '#8B1538',
        'number' => 1,
        'pillar_id' => 1,
        'articles' => [
            ['id' => 1, 'slug' => 'estimer-bien-immobilier-bordeaux', 'type' => 'Pilier', 'status' => 'published'],
            ['id' => 2, 'slug' => 'prix-immobilier-bordeaux-2025', 'type' => 'Pilier', 'status' => 'published'],
            ['id' => 3, 'slug' => 'avis-de-valeur-bordeaux', 'type' => 'Pilier', 'status' => 'published'],
            ['id' => 4, 'slug' => 'estimation-echoppe-bordelaise', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 5, 'slug' => 'dpe-prix-immobilier-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 6, 'slug' => 'estimation-appartement-bordeaux-erreurs', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 7, 'slug' => 'valeur-maison-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 8, 'slug' => 'prix-immobilier-chartrons-bordeaux-2025', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 9, 'slug' => 'prix-immobilier-cauderan-2025', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 10, 'slug' => 'immobilier-la-bastide-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 11, 'slug' => 'immobilier-bacalan-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 12, 'slug' => 'prix-immobilier-merignac-vs-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 13, 'slug' => 'vendre-son-bien-bordeaux-etapes', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 14, 'slug' => 'choisir-conseiller-immobilier-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => 15, 'slug' => 'negociation-immobiliere-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
        ],
    ],
    [
        'name' => 'Vendre vite et au bon prix à Bordeaux',
        'color' => '#1A3C5E',
        'number' => 2,
        'pillar_id' => 16,
        'articles' => [
            ['id' => 16, 'slug' => 'vendre-rapidement-bien-bordeaux', 'type' => 'Pilier', 'status' => 'published'],
            ['id' => 17, 'slug' => 'vendre-urgence-bordeaux', 'type' => 'Satellite', 'status' => 'published'],
            ['id' => null, 'slug' => 'succession-immobiliere-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'vendre-appartement-loue-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'home-staging-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'vendre-sans-agence-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
        ],
    ],
    [
        'name' => 'Acheter à Bordeaux',
        'color' => '#2D6A4F',
        'number' => 3,
        'pillar_id' => null,
        'articles' => [
            ['id' => null, 'slug' => 'guide-acheter-immobilier-bordeaux-2025', 'type' => 'Pilier', 'status' => 'todo'],
            ['id' => null, 'slug' => 'budget-acheter-bordeaux-quartier', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'frais-notaire-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'pieges-achat-immobilier-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'acheter-ou-louer-bordeaux-2025', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'offre-achat-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
        ],
    ],
    [
        ...
        'pillar_id' => null,
        'articles' => [
            ['id' => null, 'slug' => 'plus-value-immobiliere-bordeaux', 'type' => 'Pilier', 'status' => 'todo'],
            ['id' => null, 'slug' => 'taxe-fonciere-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'exoneration-plus-value-residence-principale-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'ifi-immobilier-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'frais-agence-immobiliere-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'diagnostic-termites-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
        ],
    ],
    [
        'name' => 'Investissement locatif Bordeaux',
        'color' => '#4A1942',
        'number' => 5,
        'pillar_id' => null,
        'articles' => [
            ['id' => null, 'slug' => 'investissement-locatif-bordeaux-2025', 'type' => 'Pilier', 'status' => 'todo'],
            ['id' => null, 'slug' => 'rendement-locatif-bordeaux-quartier', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'lmnp-bordeaux-quartiers-rentables', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'investir-echoppe-bordelaise-location', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'colocation-bordeaux-prix-rentabilite', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'encadrement-loyers-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
        ],
    ],
    [
        ...
        'pillar_id' => null,
        'articles' => [
            ['id' => null, 'slug' => 'renover-pour-vendre-bordeaux', 'type' => 'Pilier', 'status' => 'todo'],
            ['id' => null, 'slug' => 'renovation-energetique-avant-vente-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'passer-dpe-f-a-d-bordeaux-cout-gain', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'surelevation-echoppe-bordeaux-cout-rentabilite', 'type' => 'Satellite', 'status' => 'todo'],
            ['id' => null, 'slug' => 'home-staging-vs-travaux-bordeaux', 'type' => 'Satellite', 'status' => 'todo'],
