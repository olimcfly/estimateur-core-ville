...
<span class="keyword">URL finale :</span> <span class="string">https://estimation-immobilier-bordeaux.fr/lp/avis-valeur-gratuit</span>
  ...
  <div class="guide-section guide-section--danger" id="guide-s9">
    ...
    <ul class="guide-checklist">
      ...
      <li><i class="fas fa-times-circle"></i> <strong>Titre d'annonce &ne; titre de page :</strong> L'incohérence fait baisser la pertinence et augmente le taux de rebond</li>
  ...
  <div class="guide-section guide-section--highlight" id="guide-s10">
    ...
    <div class="guide-tip guide-tip-success">
      ...
      (<a href="/admin/leads" style="color: inherit; text-decoration: underline;">Admin &rarr; Leads</a>) avec les détails UTM dans les notes.
