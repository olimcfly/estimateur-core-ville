<?php $page_title = 'Newsletter - Estimation Immobilière ' . site('city', '') . ' | Conseils & Tendances'; ?>

<section class="section page-hero">
  <div class="container">
    <div class="page-hero-inner card">
      <p class="eyebrow"><i class="fas fa-envelope-open-text"></i> Newsletter</p>
      <h1>Recevez nos conseils immobiliers à <?= htmlspecialchars((string) site('city', 'votre ville'), ENT_QUOTES, 'UTF-8') ?></h1>
      <p class="lead">
  ...
  <div class="container" style="max-width: 840px;">
    <article class="card" style="padding: 2rem;">
      ...
      <p>
        ...
        pour mieux estimer, vendre ou acheter à <?= htmlspecialchars((string) site('city', 'votre ville'), ENT_QUOTES, 'UTF-8') ?>.
      </p>
