...
(1, 'require_keywords', 'ville,region,métropole,immobilier local'),
(1, 'max_article_age_days', '7'),
(1, 'min_relevance_score', '6'),
(1, 'article_tone', 'journalistique'),
(1, 'article_length', '800-1200'),
(1, 'seo_focus', 'estimation immobilière locale,prix immobilier local,marché immobilier local'),
(1, 'local_angle', 'Toujours adapter l''angle à Ville à configurer et sa métropole. Expliquer l''impact local pour les propriétaires locaux.'),
(1, 'cta_style', 'soft'),
(1, 'source_citation', '1'),
(1, 'auto_publish', '0'),
