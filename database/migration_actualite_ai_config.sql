...
(1, 'require_keywords', 'bordeaux,gironde,nouvelle-aquitaine,métropole bordelaise'),
(1, 'max_article_age_days', '7'),
(1, 'min_relevance_score', '6'),
(1, 'article_tone', 'journalistique'),
(1, 'article_length', '800-1200'),
(1, 'seo_focus', 'estimation immobilière bordeaux,prix immobilier bordeaux,marché immobilier bordeaux'),
(1, 'local_angle', 'Toujours adapter l''angle à Bordeaux et sa métropole. Expliquer l''impact local pour les propriétaires bordelais.'),
(1, 'cta_style', 'soft'),
(1, 'source_citation', '1'),
(1, 'auto_publish', '0'),
